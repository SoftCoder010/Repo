<div id="newBudgetContainer" class="col-md-4 hidden">
        ...
        <div class="panel-body">
            <form:form role="form" id="newBudgetForm"
                ...
                <div class=" has-success has-feedback">
                    ...
                    <form:input type="text" path="value" class="form-control" cssStyle="height: 40px"
                                id="budgetValue"
                                placeholder="Enter budget value"></form:input>

                    <label for="budgetType">Budget type</label>
                    <form:select onchange="showInputAccordingly();" path="type" id="budgetType"
                    ...
                    <form:input type="number" min="1" max="31" path="day1" id="budgetDay1"
                                cssStyle="height: 40px"
                                class="form-control"
                    ...
                    <form:input type="number" min="1" max="31" path="day2" id="budgetDay2"
                                cssStyle="height: 40px"
                                class="form-control hidden budgetDay2"
                    ...
                    <form:input type="number" min="1" max="12" path="month" id="budgetMonth"
                                cssStyle="height: 40px"
                                class="form-control hidden budgetMonth"
